...
//go:generate swagger generate server --target ../../app --name Memlab --spec ../../../swagger.yaml --template-dir /Users/wilhelmwonigkeit/Documents/GitHub/direktiv-apps/memlab/build/templates --principal interface{}

func configureFlags(api *operations.MemlabAPI) {
...
func configureAPI(api *operations.MemlabAPI) http.Handler {
